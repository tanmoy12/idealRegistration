	...
	Participant.updateEvents(req.body, (status, err, data) => {
      ...
      "	<body style=\"background-image:url(background.jpg); max-width: 800px; height: 100%;\">"+
        ...
        "	</div>"+
          ...
          "	<h2 style=\"text-align: right\">"+data.name+"</h2>"+
        "		<h2 style=\"text-align: right\">"+data.institution+"</h2>"+
          "	<h4 style=\"text-align: right\">"+data.level+" Level</h4>"+
        "		<h5 style=\"text-align: right\">("+data.email+")</h5>"+
